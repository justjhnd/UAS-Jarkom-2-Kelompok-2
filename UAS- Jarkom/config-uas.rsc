...
/interface vlan
add interface=bridge1 name=vlan46 vlan-id=46
...
set 5 default-vlan-id=46 vlan-header=always-strip vlan-mode=secure
...
add bridge=bridge1 tagged=ether1,bridge1 vlan-ids=46
